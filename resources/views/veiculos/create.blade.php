                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="marca" class="form-control @error('marca') is-invalid @enderror" 
                                   type="text" name="marca" value="{{ old('marca') }}" required autofocus />
                            @error('marca')
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="versao" class="form-control @error('versao') is-invalid @enderror" 
                                   type="text" name="versao" value="{{ old('versao') }}" />
                            @error('versao')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="ano_fab" class="form-control @error('ano_fab') is-invalid @enderror" 
                                   type="number" name="ano_fab" value="{{ old('ano_fab') }}" 
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="ano_modelo" class="form-control @error('ano_modelo') is-invalid @enderror" 
                                   type="number" name="ano_modelo" value="{{ old('ano_modelo') }}" 
                                   min="1900" max="{{ date('Y') + 1 }}" required />
                            @error('ano_modelo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="km" class="form-control @error('km') is-invalid @enderror" 
                                   type="number" name="km" value="{{ old('km') }}" min="0" required />
                            @error('km')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="chassi" class="form-control @error('chassi') is-invalid @enderror" 
                                   type="text" name="chassi" value="{{ old('chassi') }}" />
                            @error('chassi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input id="preco_compra" class="form-control @error('preco_compra') is-invalid @enderror" 
                                       type="number" name="preco_compra" value="{{ old('preco_compra') }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input id="preco_venda" class="form-control @error('preco_venda') is-invalid @enderror" 
                                       type="number" name="preco_venda" value="{{ old('preco_venda') }}" 
                                       step="0.01" min="0" required />
                                @error('preco_venda')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
